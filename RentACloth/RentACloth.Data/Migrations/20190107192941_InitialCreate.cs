        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentAClothUserId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Addresses", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_RentAClothUserId",
                        column: x => x.RentAClothUserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_RentAClothUserId",
                table: "Addresses",
                column: "RentAClothUserId");
